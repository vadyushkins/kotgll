...
class TestHandCraftedRSMStringInputWithoutSPPFSuccess {
  @Test
  ...
  fun `test 'a-star' hand-crafted grammar`(input: String) {
    ...
    assertTrue(GLL(rsm, input).parse())
  }
